...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/undertow-metrics-prometheus) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
This document describes the `feature/3.0.x` line (current version: `3.0.x.x.20260630-SNAPSHOT`).
...
```gradle
implementation 'io.github.easy4j:undertow-metrics-prometheus:3.0.x.x.20260630-SNAPSHOT'
```
